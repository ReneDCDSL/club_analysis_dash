...
# Merge the club data with the competition data
df_merged = pd.merge(df_merged, df_players[df_players['last_season'] == 2023][['current_club_id', 'date_of_birth', 'name', 'player_id']], how='left', left_on='club_id', right_on='current_club_id', suffixes=('_','_player'))
